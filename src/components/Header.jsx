...
const { isDarkMode, setDarkMode, toggleDarkMode }=useContext(AppContext)
    return (
        <div className={`${isDarkMode ? "bg-gradient-to-r border-b-8  border-purple-400 from-slate-500 to-black" : "bg-gradient-to-r border-b-8 border-black from-blue-100 to-purple-300"} w-[100%] overflow-x-hidden sm:h-[100vh] flex justify-center  rounded-b-[20%] my-[6rem] space-x-6 px-8`} >
