...
export default function Header({ data }) {
    ...
    return (
        <div className={`${isDarkMode ? "bg-gradient-to-r border-b-8  border-slate-300 from-slate-500 to-black" : "border-b-8 border-black bg-gradient-to-r  from-blue-100 to-purple-300"}  w-[100%] overflow-hidden flex justify-center  rounded-b-[20%] mb-[2rem] space-x-6 px-8`} >
