...
export default function Header({ data }) {
    ...
    return (
        <div className="w-[100%] overflow-x-hidden sm:h-[100vh] flex justify-center  rounded-b-[20%] border-b-8 border-black  bg-gradient-to-r from-blue-100 to-purple-300  my-[6rem] space-x-6 px-8">
