...
export default function ProductItem() {
    ...
    return (
        <div className={`${isDarkMode ? "bg-gradient-to-r  from-slate-500 text-white to-black" : "bg-gradient-to-r from-blue-100  to-purple-100"}  max-[400px]:px-[0.5rem] min-h-screen h-full py-[10rem]` }>
