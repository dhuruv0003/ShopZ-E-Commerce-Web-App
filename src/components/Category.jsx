...
export default function Category() {
  ...
  return (
    <div className=" mt-[6rem] relative py-7 sm:flex-col max-w-[800px] mx-auto flex justify-evenly items-center md:-left-[4rem]">
      <div onClick={()=>setHide((prev)=>!prev)} className="absolute left-[1rem] text-2xl  flex  items-center gap-3  text-[#b66161] cursor-pointer ">
        <TfiMenu  className='font-extrabold text-4xl shadow-md shadow-rose-950'/> <p className=' text-3xl font-bold bg-gradient-to-r from-pink-500 to-indigo-400 p-2 inline-block text-transparent bg-clip-text'>Category</p>
      </div>
