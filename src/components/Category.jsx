  ...
  return (
    <div className=" mt-[6rem] relative pt-[4rem] sm:flex-col max-w-[800px] mx-auto flex justify-evenly items-center md:-left-[4rem]">
      <div onClick={()=>setHide((prev)=>!prev)} className="absolute md:left-[2rem] left-[1rem] text-2xl  flex  items-center gap-3  text-[#ffffff] cursor-pointer ">
        ...
        <TfiMenu  className='font-extrabold text-4xl shadow-md  shadow-rose-950 bg-gradient-to-r from-pink-500 to-indigo-400 rounded-lg p-[2px]  text-slate-100'/> <p className=' text-3xl font-bold bg-gradient-to-r  from-pink-500 to-indigo-400 p-2 inline-block text-transparent bg-clip-text'>Category</p>
      </div>
