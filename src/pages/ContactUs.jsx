...
export const ContactUs = () => {
    ...
    return (
        <div onClick={() => setHide(true)} className={`${isDarkMode ? "bg-gradient-to-r from-slate-400 to-slate-950 shadow-slate-900 300 pt-[8rem] h-full md:w-screen max-[600px]:px-[0.5rem]" : 'bg-gradient-to-r from-blue-100 to-purple-100 pt-[8rem]  h-fit  md:w-screen max-[600px]:px-[0.5rem]'}`}>
